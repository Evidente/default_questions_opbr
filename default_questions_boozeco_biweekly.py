default_questions = [
...

  {
    "question":
      ...
      "for the fortnigh that ends on {DATE} for the top {top_n_high_performance_stores} stores in high performance.",
    "query": """
      ...
      (
        ...
        WHERE 
          EXTRACT(DATE FROM sn.snapshot_date) = DATE_SUB(DATE('{DATE}'), INTERVAL 15 DAY)
        GROUP BY 
          st.store_id,
          st.store_name
      ), 
      ...
      (
        ...
        WHERE 
          EXTRACT(DATE FROM m.movement_date) BETWEEN DATE_SUB(DATE('{DATE}'), INTERVAL 14 DAY) AND '{DATE}'
        GROUP BY 
          st.store_id,
          st.store_name
      ) 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "for the fortnigh that ends on {DATE} for the top {top_n_low_performance_stores} stores in low performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "ffor the fortnigh that ends on {DATE} for the top {top_n_high_performance_items} items in high performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "for the fortnigh that ends on {DATE} for the top {top_n_low_performance_items} items in low performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "for the fortnigh that ends on {DATE} for the top {top_n_high_performance_categories} categories in high performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "for the fortnigh that ends on {DATE} for the top {top_n_low_performance_categories} categories in low performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "for the fortnigh that ends on {DATE} for the top {top_n_high_performance_stores} stores with more inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
      ...
      (
        ...
        JOIN dim_stores st ON m.store_id = st.store_id 
        WHERE 
          EXTRACT(DATE FROM m.movement_date) BETWEEN DATE_SUB(DATE('{DATE}'), INTERVAL 14 DAY) AND '{DATE}' AND 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "for the fortnigh that ends on {DATE} for the top {top_n_low_performance_stores} stores with less inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "for the fortnigh that ends on {DATE} for the top {top_n_high_performance_items} items with more inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "for the fortnigh that ends on {DATE} for the top {top_n_low_performance_items} items with less inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "for the fortnigh that ends on {DATE} for the top {top_n_high_performance_categories} categories with more inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "for the fortnigh that ends on {DATE} for the top {top_n_low_performance_categories} categories with less inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "last sale, "
      "days without sales "
      "for the fortnight that ends on {DATE} for the top {top_n_high_performance_stores} stores with more days without sales.",
    "query": """
      SELECT 
        st.store_id,
        st.store_name,
  ...
  },
  {
    "question":
      ...
      "last sale, "
      "days without sales "
      "for the fortnight that ends on {DATE} for the top {top_n_high_performance_items} items with more days without sales.",
    "query": """
      SELECT 
        i.item_id,
        i.item_name,
  ...
  },
  {
    "question":
      ...
      "last sale, "
      "days without sales "
      "for the fortnight that ends on {DATE} for the top {top_n_high_performance_categories} categories with more days without sales.",
    "query": """
      SELECT 
        c.category_id,
        c.category_name,
