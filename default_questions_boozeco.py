default_questions = [
  ...
  },
  {
    "question":
      ...
      "average order value and "
      "items per transaction, "
      "comparing the week{DATE} versus the same weekday from {n_weeks} week(s) ago",
    "query": """
      WITH current_day AS 
      (
        SELECT
    ...
    "query": """
      ...
      (
        ...
        SELECT 
          s.forecast_value AS total_sales, 
          c.forecast_value AS total_cost, 
          (s.forecast_value - c.forecast_value) AS margin, 
          (s.prediction_interval_lower_bound - c.prediction_interval_lower_bound) AS prediction_interval_lower_bound, 
          (s.prediction_interval_upper_bound - c.prediction_interval_upper_bound) AS prediction_interval_upper_bound 
        FROM sales s, costs c
      ), 
  ...
  },
  {
    ...
    "query": """
      ...
      SELECT 
        (COALESCE(s.forecast_value, 0) - COALESCE(c.forecast_value, 0)) AS margin, 
        (COALESCE(s.prediction_interval_lower_bound, 0) - COALESCE(c.prediction_interval_lower_bound, 0)) AS prediction_interval_lower_bound, 
        (COALESCE(s.prediction_interval_upper_bound, 0) - COALESCE(c.prediction_interval_upper_bound, 0)) AS prediction_interval_upper_bound 
      FROM sales s, costs c
    """
...

  {
    ...
    "query": """
      ...
      (
        ...
        WHERE 
          EXTRACT(DATE FROM sn.snapshot_date) = DATE_SUB(DATE('{DATE}'), INTERVAL 1 DAY)
        GROUP BY 
          st.store_id,
          st.store_name
      ), 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "from {DATE} for the top {top_n_high_performance_items} items in high performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      "What was our "
      "inventory turnover ratio, "
      "from {DATE} for the top {top_n_low_performance_items} items in low performance.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
...

  {
    "question":
      ...
      "from {DATE} for the top {top_n_high_performance_stores} stores with more inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
      ...
      (
        ...
        JOIN dim_stores st ON m.store_id = st.store_id 
        WHERE 
          EXTRACT(DATE FROM m.movement_date) = '{DATE}' AND 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "from {DATE} for the top {top_n_low_performance_stores} stores with less inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "from {DATE} for the top {top_n_high_performance_items} items with more inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "from {DATE} for the top {top_n_low_performance_items} items with less inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "from {DATE} for the top {top_n_high_performance_categories} categories with more inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "avg quantity sold, "
      "days of inventory available "
      "from {DATE} for the top {top_n_low_performance_categories} categories with less inventory available.",
    "query": """
      WITH initial_inventory AS 
      (
        SELECT 
  ...
  },
  {
    "question":
      ...
      "last sale, "
      "days without sales "
      "from {DATE} for the top {top_n_high_performance_stores} stores with more days without sales.",
    "query": """
      SELECT 
        st.store_id,
        st.store_name,
  ...
  },
  {
    "question":
      ...
      "last sale, "
      "days without sales "
      "from {DATE} for the top {top_n_high_performance_items} items with more days without sales.",
    "query": """
      SELECT 
        i.item_id,
        i.item_name,
  ...
  },
  {
    "question":
      ...
      "last sale, "
      "days without sales "
      "from {DATE} for the top {top_n_high_performance_categories} categories with more days without sales.",
    "query": """
      SELECT 
        c.category_id,
        c.category_name,
